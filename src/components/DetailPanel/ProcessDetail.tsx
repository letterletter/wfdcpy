        ...
        <div className={styles.panelBody}>
          ...
          <div className={styles.panelRow}>
            <div>
              ...
              <Button disabled={readOnly} onClick={() => setDataObjsModalVisible(true)}>
                {i18n['tooltip.edit']}
              </Button>
            </div>
          </div>
          <div className={styles.panelRow}>
            <div>
              ...
              <Button disabled={readOnly} onClick={() => setSignalDefsModalVisible(true)}>
                {i18n['tooltip.edit']}
              </Button>
            </div>
          </div>
          <div className={styles.panelRow}>
            <div>
              ...
              <Button disabled={readOnly} onClick={() => setMessageDefsModalVisible(true)}>
                {i18n['tooltip.edit']}
              </Button>
            </div>
          </div>
