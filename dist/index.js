...
var EditableTable = _interopDefault(require('antd-etable'));
...
var Item = _interopDefault(require('@antv/g6/lib/item/item'));
          ...
          var cmd = util.mix(
            {},
            {
              ...
              execute: function execute(graph) {
                ...
                this.method &&
                  (util.isString(this.method) ? graph[this.method]() : this.method(graph));
              },
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement(antd.Input.TextArea, {
          style: {
            width: '100%',
            fontSize: 12,
          },
...
var DetailPanel = React.forwardRef(function(_ref, ref) {
...
var ItemPanel = React.forwardRef(function(_ref, ref) {
  var height = _ref.height;
...
function dragEdge(G6) {
  G6.registerBehavior('dragEdge', {
    ...
    sameNode: function sameNode(e) {
      return (
        e.target instanceof shape.Marker &&
        e.target.getParent() &&
        e.target
          .getParent()
          .getParent()
  ...
  G6.registerBehavior('itemAlign', {
    ...
    _itemAlign: function _itemAlign(item) {
      ...
      util.each(nodes, function(node) {
        ...
        util.each(_this.getVerticalLines(bbox1), function(line) {
